...
<h3 align="left"> Yii framework update (recommended for PHP 8.2/8.3+) </h3>

Yiimp uses <b>Yii 1.1</b> (maintenance mode). Newer Yii 1.1 releases include
compatibility and security fixes for modern PHP.

Run this once before deploying:

<pre><code>cd yiimp-dev
sudo ./bin/update-yii-framework.sh
</code></pre>

This replaces <code>./web/framework</code> with the latest Yii 1.1 release archive.
