...
<div class="input-group">
  <input type="text" name="address" class="form-control font-monospace" placeholder="Wallet Address">
  <button class="btn btn-primary" type="submit"><i class="bi bi-search me-1"></i>Submit</button>
</div>
<div class="form-text text-body-secondary">Example: <span class="font-monospace">/?address=YOUR_WALLET</span></div><br>
END;
...
echo <<<END
    ...
    <div class="col-lg-6">
      ...
      <div id='found_results' class="yiimp-ajax-block mt-4">
        <div class="card yiimp-card">
          <div class="card-body placeholder-glow">
      ...
      <div class="card yiimp-card mt-4">
        <div class="card-body">
          <h2 class="h6 mb-1">Tip</h2>
          <div class="text-body-secondary small">Use URL format <span class="font-monospace">/?address=YOUR_WALLET</span> for quick access (bookmark it).</div>
        </div>
      </div>
    </div><!-- /col -->
  </div><!-- /row -->
